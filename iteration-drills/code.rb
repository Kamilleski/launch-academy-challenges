...
array.each do |name|
  if name.length < 5
    short_name_counter = short_name_counter + 1
  end
end
puts short_name_counter
...
array.each do |name|
  if name.length > 5
    long_name_counter = long_name_counter + 1
  end
end
puts long_name_counter

# * How many names in `array` are exactly 5 characters in length?
fives_name_counter = 0
array.each do |name|
  if name.length == 5
    fives_name_counter = fives_name_counter + 1
  end
end
puts fives_name_counter
