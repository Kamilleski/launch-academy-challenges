...
twitter_data.each do |tweeter|
  print tweeter.keys[0] + ": "
  tweeter.each do |username, values|
...
twitter_data.each do |tweeter|
  tweeter.each do |username, values|
    puts "#{tweeter.keys[0]} used #{values["latest tweet"].length} characters in their latest tweet."
  end
end
...
twitter_data.each do |user_data|
  user_data.each do |username, data|
    data["last twenty tweets"].each do |tweet|
      char_count += tweet.length
    end
    puts "#{user_data.keys[0]} used #{char_count} characters in their last twenty tweets."
    char_count = 0
  end
end
...
twitter_data.each do |user_data|
  user_data.each do |username, data|
    if data["number of followers"] > current_highest
      current_highest = data["number of followers"]
      popularest_user = username
    end
  end
end

puts "#{popularest_user} has #{current_highest} followers."

# # * Which user has the most friends?
friendliest_user = nil
current_highest = 0
twitter_data.each do |user_data|
  user_data.each do |username, data|
    if data["number of friends"] > current_highest
      current_highest = data["number of friends"]
      friendliest_user = username
    end
  end
end

puts "#{friendliest_user} has the most friends (#{current_highest})."
...
twitter_data.each do |user_data|
  user_data.each do |username, data|
    if data["number of tweets"] > current_highest
      current_highest = data["number of tweets"]
      tweetiest_user = username
    end
  end
end
puts "#{tweetiest_user} has the most tweets (#{current_highest})."
...
twitter_data.each do |user_data|
  user_data.each do |username, data|
    if !data["description"].nil?
      descriptive_users.push(username)
    end
  end
end

descriptive_users.each do |handle|
  puts handle
end
...
twitter_data.each do |user_data|
  user_data.each do |username, data|
    if !data["location"].nil?
      locatable_users.push(username)
    end
  end
end

locatable_users.each do |handle|
  puts handle
end
